...
<img src="campus.jpeg" alt="School Image" style="width: 100%; height: auto; max-height: 500px; object-fit: cover; border-radius: 8px;">        
  </div>`;
      break;
          ...
          <div class="container">
            ...
            <div class="founder">
                ...
                <center>
                    ...
                    <img src="founder.jpg" alt="College Logo" style="width: 180px; height: auto; margin-left: 20px;">
    
                     <b><p class="headingstyle">The Secretry</b><br>
                    Kunbi Shikshan Prasarak Sanstha Khed, Mumbai
                </center>
          <p class="nospace">Heartly Welcome, Heartly Welcome, Kunbi Shikshan Prasarak Sanstha Khed-Mumbai established the Junior College of Education Bharne was established on 10/10/1984. It is located in hilly, remote and economically backward rural area of the district of Ratnagiri in the Konkan region of Maharashtra.</p>
          <img src="comiteemembers.jpg" alt="College Logo" style="width: 680px; height: 380; margin-left: 20px;">         
            </div> `;
      break;
...
The candidate who wants to apply for the admission should apply in the same medium from which he/<br>she has completed his/her 10th & 12th If the candidate tries unnecessarily there will be no consideration.
    ...
    case 'infrastructure':
      content.innerHTML = `
        ...
        <div class="infra-item">
            <img src="multipurposehall.jpeg" alt="Multipurpose Hall">
          ...
          <div class="infra-item">
            <img src="smartlab.jpeg" alt="Computer Lab">
            <p class="infra-title">Computer Lab</p>
          </div> 

        <div class="infra-item">
            <img src="Playground1.jpeg" alt=library">
            <p class="infra-title">Play Ground </p>
          </div>

          <div class="infra-item">
            <img src="Playground2.jpeg" alt=library">
            <p class="infra-title">Play Ground</p>
          </div>       
        </div>
      `;
...
//"https://via.placeholder.com/300x200?text=Event+5"image add by saloni
 ...
 case 'documents':
    ...
    case 'contact':
      content.innerHTML = `
        <h1>Contact Us</h1>
        <p><h2>College Address:</h2> Kunabi Shikhshan Prasarak<br> Sanstha Khed,Mumbai <br> Adhyapak Vidyalaya Bharne <br> Tal-Khed, <br> Dist-Ratnagiri<br>(Maharashtra)<br>pin-415621<br>Tel No: 02356-263461<br>Email:<a href="dtedbharne@yahoo.com">dtedbharne@yahoo.com</a><br>Fex No: 02356-263461<br>Principal-9422630162<br>Office Concact:9561414130<br>8433536247<br><H3>Visit Us at:</h3><a href="https://juniorcollegeofeducationbharne.com/">https://juniorcollegeofeducationbharne.com/</a></p>`;
      break;
  }
}
